package com.utm.bubblescanner.liveedgedetection.view;
...
public class PolygonView extends FrameLayout {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int radius = ScanUtils.dp2px(context, 12);
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            switch (eid) {
                ...
                case MotionEvent.ACTION_DOWN:
                    ScanActivity.sDraggedPoints.push(new PolygonPoints(new PointF(pointer1.getX(), pointer1.getY()),
